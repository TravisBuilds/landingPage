...
exports.default = create_testing_library_rule_1.createTestingLibraryRule({
    ...
    create(context, [], helpers) {
        ...
        function showErrorIfChainedContainerMethod(innerNode) {
            if (node_utils_1.isMemberExpression(innerNode)) {
        ...
        return {
            ...
            VariableDeclarator: function (node) {
                ...
                if (node_utils_1.isObjectPattern(node.id)) {
                    const containerIndex = node.id.properties.findIndex((property) => node_utils_1.isProperty(property) &&
                    ...
                    if (experimental_utils_1.ASTUtils.isIdentifier(nodeValue)) {
                        ...
                        node_utils_1.isObjectPattern(nodeValue) &&
                            nodeValue.properties.forEach((property) => node_utils_1.isProperty(property) &&
                                experimental_utils_1.ASTUtils.isIdentifier(property.key) &&
