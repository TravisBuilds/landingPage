    ...
    create(context, _, helpers) {
            ...
            context.report({
                ...
                fix(fixer) {
                    ...
                    const newAllRequired = node.properties
                        .filter((s) => node_utils_1.isProperty(s) &&
        ...
        return {
            ...
            'Program:exit'() {
                ...
                if (node_utils_1.isCallExpression(testingLibraryNode)) {
                    const parent = testingLibraryNode.parent;
                    if (!node_utils_1.isObjectPattern(parent.id)) {
                        return;
                    }
                    ...
                    if (testingLibraryNode.specifiers.length === 1 &&
                        node_utils_1.isImportNamespaceSpecifier(testingLibraryNode.specifiers[0])) {
                        return;
                    }
